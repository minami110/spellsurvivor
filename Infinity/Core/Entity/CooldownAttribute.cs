...
public abstract class ReadOnlyCooldownAttribute : ReadOnlyEntityAttribute<uint>
{
...
public sealed class CooldownAttribute : ReadOnlyCooldownAttribute
{
    ...
    public CooldownAttribute(uint value, float rate)
    {
        DefaultValue = value;
        DefaultRate = rate;
